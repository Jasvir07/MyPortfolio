  ...
  return (
    <div className="bg-black rounded-lg overflow-hidden transition-transform duration-300 hover:scale-105 border flex flex-col justify-between min-h-min w-10/12 mx-auto">
      <img
        src={image}
        alt={name}
        className="project-image w-full h-44 object-cover"
      />
      <div className="flex flex-col justify-center flex-grow p-4">
        <h2 className="project-name text-green-400 text-xl font-bold text-center">
          {name}
        </h2>
        <p className="project-description text-gray-400 text-base text-center mb-2">
          {description}
        </p>
      </div>
